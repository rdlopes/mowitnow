...
Et ::
=====
une tondeuse 1 intialement en position 1, 2, N qui doit exécuter les instructions GAGAGAGAA icon:thumbs-up[role="green",title="Passed"] [small right]#(017ms)#
=====
Et ::
=====
...
Quand ::
=====
les instructions sont exécutées icon:thumbs-up[role="green",title="Passed"] [small right]#(009ms)#
=====
Alors ::
=====
la position finale de la tondeuse 1 doit être 1 3 N icon:thumbs-up[role="green",title="Passed"] [small right]#(048ms)#
=====
Et ::
=====
