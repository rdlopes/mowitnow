...
Etant donné ::
=====
une pelouse de largeur 6 et de hauteur 6 icon:thumbs-up[role="green",title="Passed"] [small right]#(110ms)#
=====
Et ::
=====
une tondeuse 1 intialement en position 1, 2, N qui doit exécuter les instructions GAGAGAGAA icon:thumbs-up[role="green",title="Passed"] [small right]#(013ms)#
=====
Et ::
=====
...
Quand ::
=====
les instructions sont exécutées icon:thumbs-up[role="green",title="Passed"] [small right]#(007ms)#
=====
Alors ::
=====
la position finale de la tondeuse 1 doit être 1 3 N icon:thumbs-up[role="green",title="Passed"] [small right]#(069ms)#
=====
Et ::
=====
